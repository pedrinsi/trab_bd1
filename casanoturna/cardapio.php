...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				$('.busca').blur(function(){
					if($(this).val() == '')
					{
					  ...
					  window.location = 'cardapio.php';
						...
						if ($(this).val()!="") {
							window.location = 'cardapio.php?string='+$(this).val();
						}
					}
				});
			});
			
			function deleta_cardapio(id_cardapio){
					var confirma = confirm("deseja realmente deletar este cardapio ?");
					if(confirma) {
						window.location = 'cardapio.php?deletar=true&i='+id_cardapio;
					}
				} 
		</script>
	...
	<body>
		...
		<div id="Corpo">		
			...
			<div class="conteudo">
				<div class="campo_conteudo"><h1>CARDAPIOS</h1>
					...
					<div class="campo_botoes">
						...
						<a href="cardapio_form.php">Cadastrar cardapio</a>
					</div>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="javascript:deleta_cardapio(<?=$linha['id']?>);" ><img src="public/img/icon_deletar.png" alt="" title="Remover" width="16" height="16" />
										</td>
									</tr>
									<?php } else { ?>
									<tr class="impar">
