<?php
	...
	$id_cardapio = (isset($_GET['i'])) ? $_GET['i'] : $next_id[0]['Auto_increment'];
	
	$manipula = new Manipula;
	$manipula->setTabela("cardapio");
	$manipula->setChave("id");	
	
	$manipula->addCampo("descricao","","string");


	$manipula->setAfterUpdate("cardapio.php");
	$manipula->setAfterInsert("cardapio.php");	
				...
				<div class="campo_conteudo">
					...
					<form action="" method="post">
						<div class="cadastra">
							...
							<div>
								<p>
								Listagem de bebidas e Comidas para inserir no cardapio!!
								Insert no item cardapio!
								</p>
							</div>
